    ...
    <div className="min-h-[80vh] flex items-center justify-center anim-fade-rise">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1 dark:text-slate-400">Start tracking your Cambridge past papers</p>
        </div>
        ...
        <div className="card p-6">
          ...
          <div className="mt-6 text-center">
            <Link to="/login" className="text-sm text-primary-600 hover:text-primary-700 font-medium dark:text-primary-400 dark:hover:text-primary-300">
